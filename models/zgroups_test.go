...
func zgroupBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func zgroupAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Zgroup) error {
	*o = Zgroup{}
	return nil
}

func testZgroupsHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, zgroupDBTypes, false); err != nil {
		t.Errorf("Unable to randomize Zgroup object: %s", err)
	}

	AddZgroupHook(boil.BeforeInsertHook, zgroupBeforeInsertHook)
	...
	zgroupBeforeInsertHooks = []ZgroupHook{}

	AddZgroupHook(boil.AfterInsertHook, zgroupAfterInsertHook)
	...
	zgroupAfterInsertHooks = []ZgroupHook{}

	AddZgroupHook(boil.AfterSelectHook, zgroupAfterSelectHook)
	...
	zgroupAfterSelectHooks = []ZgroupHook{}

	AddZgroupHook(boil.BeforeUpdateHook, zgroupBeforeUpdateHook)
	...
	zgroupBeforeUpdateHooks = []ZgroupHook{}

	AddZgroupHook(boil.AfterUpdateHook, zgroupAfterUpdateHook)
	...
	zgroupAfterUpdateHooks = []ZgroupHook{}

	AddZgroupHook(boil.BeforeDeleteHook, zgroupBeforeDeleteHook)
	...
	zgroupBeforeDeleteHooks = []ZgroupHook{}

	AddZgroupHook(boil.AfterDeleteHook, zgroupAfterDeleteHook)
	...
	zgroupAfterDeleteHooks = []ZgroupHook{}

	AddZgroupHook(boil.BeforeUpsertHook, zgroupBeforeUpsertHook)
	...
	zgroupBeforeUpsertHooks = []ZgroupHook{}

	AddZgroupHook(boil.AfterUpsertHook, zgroupAfterUpsertHook)
	...
	zgroupAfterUpsertHooks = []ZgroupHook{}
}
