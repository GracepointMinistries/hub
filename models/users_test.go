...
func testUserToManyGroups(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"group_members\" (\"user_id\", \"group_id\") values ($1, $2)", a.ID, b.ID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"group_members\" (\"user_id\", \"group_id\") values ($1, $2)", a.ID, c.ID)
	if err != nil {
		t.Fatal(err)
	}
